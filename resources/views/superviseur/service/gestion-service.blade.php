...
<html lang="fr">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <link rel="canonical" href="https://preview.keenthemes.com/keen/demo1/apps/customers/list.html" />
    ...
    >
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            <!--begin::Page-->
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page"></div>
                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                                    Historique Demande
                                </h>
                            </div>
                        </div>
                        ...
                        <div id="kt_app_content_container" class="app-container container-fluid">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-title">
                                        ...
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <input type="text" data-kt-customer-table-filter="search" class="form-control form-control border border-gray-300 w-250px ps-12" placeholder="Chercher Utilisateur" />
                                        </div>
                                        <!--end::Search-->
                                    </div>
                                    <!--begin::Card title-->
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                                <i class="ki-duotone ki-filter fs-2"><span class="path1"></span><span class="path2"></span></i> Filtre
                                            </button>
                                            <!--begin::Menu 1-->
                                            ...
                                            <!--begin::Add customer-->
                                            <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('superviseur.utilisateur.ajouter') }}'">
                                                Ajouter Utilisateur
                                            </button>
                                ...
                                <div class="card-body pt-0">
                                    <!--begin::Table-->
                                    <<table class="table align-middle table-row-bordered fs-6 gy-5" id="kt_customers_table">
                                        <thead>
                                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-125px">Nom Utilisateur</th>
                                                <th class="min-w-125px">Email</th>
                                                <th class="min-w-125px">Service</th>
                                                <th class="min-w-125px">Date création</th>
                                                <th class="min-w-125px">Date Fin Contrat</th>
                                        ...
                                        <tbody class="fw-semibold text-gray-600 border-top">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                                                </td>
                                                <td>
                                                ...
                                                <td data-filter="mastercard">
                                                    <img src="/keen/demo1/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />
                                                    **** 3668
                                                </td>
                                                <td>
                                                    14 Dec 2020, 8:43 pm
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="/keen/demo1/apps/customers/view.html" class="menu-link px-3">
                                                                View
                                                            </a>
                                                        </div>
                                                        <!--end::Menu item-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
                                                </td>
                                                <td>
                                                ...
                                                <td data-filter="visa">
                                                    <img src="/keen/demo1/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />
                                                    **** 7971
                                                </td>
                                                <td>
                                                    01 Dec 2020, 10:12 am
                                                </td>
                                                <td class="text-end">
                                                    <a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                                        Actions
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
                                                </td>
                                                <td>
                                                ...
                                                <td data-filter="american_express">
                                                    <img src="/keen/demo1/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />
                                                    **** 2446
                                                </td>
                                                <td>
                                                    21 Oct 2020, 5:54 pm
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/keen/demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
                                                </td>
                                                <td>
                            ...
                            <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="/keen/demo1/apps/customers/list.html">
                                            <!--begin::Modal header-->
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                >
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--begin::Input-->
                                                        <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="name" value="Sean Bean" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--begin::Input-->
                                                        <input type="email" class="form-control form-control border border-gray-300" placeholder="" name="email" value="sean@dellito.com" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    ...
                                                    <div id="kt_modal_add_customer_billing_info" class="collapse show">
                                                        ...
                                                        <div class="d-flex flex-column mb-7 fv-row">
                                                            ...
                                                            <!--begin::Input-->
                                                            <input class="form-control form-control border border-gray-300" placeholder="" name="address1" value="101, Collins Street" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="d-flex flex-column mb-7 fv-row">
                                                            ...
                                                            <!--begin::Input-->
                                                            <input class="form-control form-control border border-gray-300" placeholder="" name="address2" value="" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="d-flex flex-column mb-7 fv-row">
                                                            ...
                                                            <!--begin::Input-->
                                                            <input class="form-control form-control border border-gray-300" placeholder="" name="city" value="Melbourne" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="row g-9 mb-7">
                                                            ...
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <!--begin::Input-->
                                                                <input class="form-control form-control border border-gray-300" placeholder="" name="state" value="Victoria" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Col-->
                                                            ...
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <!--begin::Input-->
                                                                <input class="form-control form-control border border-gray-300" placeholder="" name="postcode" value="3000" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            ...
                                            <form id="kt_customers_export_form" class="form" action="#">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <!--begin::Input-->
                                                    <input class="form-control form-control border border-gray-300" placeholder="Pick a date" name="date" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex gap-7">
                                        ...
                                        <div class="form-check form-check-custom form-check-success form-check-solid form-check-sm">
                                            ...
                                            <!--begin::Label-->
                                            <label class="form-check-label text-gray-700 fw-bold text-nowrap" for="kt_layout_builder_page_width_default"> Default </label>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Check-->
                                        <!--begin::Check-->
                                        <div class="form-check form-check-custom form-check-success form-check-solid form-check-sm">
                                            ...
                                            <!--begin::Label-->
                                            <label class="form-check-label text-gray-700 fw-bold text-nowrap" for="kt_layout_builder_page_width_fluid"> Fluid </label>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Check-->
                                        <!--begin::Check-->
                                        <div class="form-check form-check-custom form-check-success form-check-solid form-check-sm">
                                            ...
                                            <!--begin::Label-->
                                            <label class="form-check-label text-gray-700 fw-bold text-nowrap" for="kt_layout_builder_page_width_fixed"> Fixed </label>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Check-->
                                    </div>
            ...
            <div class="card shadow-none border-0 rounded-0">
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        ...
                                        <div class="fs-5 fw-semibold mb-2">
                                            Task <a href="#" class="text-primary fw-bold me-1">#45890</a> merged with <a href="#" class="text-primary fw-bold me-1">#45890</a> in “Ads Pro Admin Dashboard project:
                                        </div>
                                        <!--end::Title-->
                ...
                <div class="card-footer py-5 text-center" id="kt_activities_footer">
                    <a href="/keen/demo1/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">
                        View All Activities <i class="ki-duotone ki-arrow-right fs-3 text-primary"><span class="path1"></span><span class="path2"></span></i>
                    </a>
                </div>
                <!--end::Footer-->
            </div>
                    ...
                    >
                        ...
                        <div class="d-flex justify-content-start mb-10">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle"><img alt="Pic" src="/keen/demo1/assets/media/avatars/300-25.jpg" /></div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-3">
                        ...
                        <div class="d-flex justify-content-end mb-10">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle"><img alt="Pic" src="/keen/demo1/assets/media/avatars/300-1.jpg" /></div>
                                    <!--end::Avatar-->
                                </div>
                                <!--end::User-->
                        ...
                        <div class="d-flex justify-content-start mb-10">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <!--begin::Text-->
                                <div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start" data-kt-element="message-text">
                                    You can unwatch this repository immediately by clicking here: <a href="https://keenthemes.com">Keenthemes.com</a>
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Wrapper-->
                ...
                <div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="Coming soon">
                                <i class="ki-duotone ki-cloud-add fs-3"><span class="path1"></span><span class="path2"></span></i>
                            </button>
                        </div>
                        <!--end::Actions-->
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex flex-column me-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="#" class="btn btn-sm btn-light-success btn-icon-success btn-icon w-25px h-25px me-2"> <i class="ki-duotone ki-minus fs-4"></i> </a>

                                <a href="#" class="btn btn-sm btn-light-success btn-icon w-25px h-25px"> <i class="ki-duotone ki-plus fs-4"></i> </a>
                            </div>
                            <!--end::Wrapper-->
                        </div>
                        <!--end::Wrapper-->
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <i
                                                class="text-gray-500 fas fa-exclamation-circle ms-1 fs-7"
            ...
            <div class="modal-dialog mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                        ...
                        <!--begin::Textarea-->
                        <textarea class="form-control form-control border border-gray-300 mb-8" rows="3" placeholder="Type or paste emails here"> </textarea>
                        <!--end::Textarea-->
        ...
        <script src="/keen/demo1/assets/js/custom/apps/customers/list/export.js"></script>
        <script src="/keen/demo1/assets/js/custom/apps/customers/list/list.js"></script>
        <script src="/keen/demo1/assets/js/custom/apps/customers/add.js"></script>
