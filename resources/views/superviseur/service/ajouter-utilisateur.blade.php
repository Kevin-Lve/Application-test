...
<head>
   ...
   <link rel="canonical" href="https://preview.keenthemes.com/keen/demo1/pages/careers/apply.html"/>
...
<body  id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true"  class="app-default" >
                        ...
                        <div class="d-flex flex-column flex-xl-row">
                           ...
                           <div class="card bg-body me-xl-9 mb-9 mb-xl-0">
                              <div class="card-body">
                                 ...
                                 <!--begin::Form-->
                                 @extends('layouts.app')
                                 @section('title', 'Créer utlisateur')
                                 @section('content')
                                 @endsection
                                 <form action="" class="form mb-15" method="post" id="kt_careers_form">
                                    ...
                                    <div class="row mb-5">
                                       ...
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--begin::Input-->
                                          <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="first_name"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                       <!--begin::Col-->
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--end::Input-->
                                          <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="last_name"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                       ...
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--begin::Input-->
                                          <input class="form-control form-control border border-gray-300" placeholder="" name="email"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                       <!--begin::Col-->
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--end::Input-->
                                          <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="mobileno"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                       ...
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--begin::Input-->
                                          <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="age"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                       <!--begin::Col-->
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--end::Input-->
                                          <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="city"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                       ...
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--begin::Input-->
                                          <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="salary"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                       <!--begin::Col-->
                                       <div class="col-md-6 fv-row">
                                          ...
                                          <!--end::Label-->
                                          <!--end::Input-->
                                          <input type="text" class="form-control form-control border border-gray-300" placeholder="" name="start_date"/>
                                          <!--end::Input-->
                                       </div>
                                       <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                       ...
                                       <!--end::Label-->
                                       <!--begin::Input-->
                                       <input class="form-control form-control border border-gray-300" placeholder="" name="website"/>
                                       <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5">
                                       ...
                                       <textarea class="form-control form-control border border-gray-300" rows="2" name="experience" placeholder="">
                                       </textarea>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-8">
                                       ...
                                       <textarea class="form-control form-control border border-gray-300" rows="4" name="application" placeholder="">
                                       </textarea>
                                    </div>
                                    <!--end::Input group-->    
                                    <!--begin::Separator-->
   ...
   <script src="/keen/demo1/assets/js/custom/pages/careers/apply.js"></script>
