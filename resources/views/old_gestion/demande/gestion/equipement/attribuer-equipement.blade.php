...
<div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
   ...
   <div id="kt_app_content" class="app-content  flex-column-fluid ">
    ...
    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
        {{$equipement->sous_categorie->nom}} par {{$equipement->sous_categorie->fournisseur->nom}}
            </h1>
    <!--end::Title-->
        <!--end::Breadcrumb-->
    </div>
               ...
               <!-- <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-lg-n2 me-auto" role="tablist">
                  <li class="nav-item" role="presentation">
                     <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_sales_order_summary" aria-selected="false" role="tab" tabindex="-1">Order Summary</a>
                  </li>
                  <li class="nav-item" role="presentation">
                     <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_ecommerce_sales_order_history" aria-selected="true" role="tab">Order History</a>
                  </li>
               </ul> -->
               <!--end:::Tabs-->
               <!--begin::Button-->
               <a href="/keen/demo1/apps/ecommerce/sales/listing.html" class="btn btn-icon btn-light btn-active-secondary btn-sm ms-auto me-lg-n7">
               <i class="ki-duotone ki-left fs-2"></i>    </a>
               <!--end::Button-->
               <!--begin::Button-->
               <a href="/keen/demo1/apps/ecommerce/sales/edit-order.html" class="btn btn-success btn-sm me-lg-n7">Edit Order</a>
               <!--end::Button-->
               <!--begin::Button-->
               <a href="/keen/demo1/apps/ecommerce/sales/add-order.html" class="btn btn-primary btn-sm">Add New Order</a>
               <!--end::Button-->
            </div>
            <!--begin::Order summary-->
    ...
    border-radius: 5px; /* Optional rounded corners */
     ...
     style="background-image: url('https://www.ecodair.com/5689-large_default/clavier-azerty-usb.jpg'); width: 300px; height: 200px;">
</div>
                        ...
                        <table class="table align-middle table-row-dashed mb-0 fs-6 gy-5 min-w-300px">
                           <tbody class="fw-semibold text-gray-600 border-top">
                                 ...
                                 <td class="fw-bold text-end">
                                    <div class="d-flex align-items-center justify-content-end">
                                       ...
                                       <div class="symbol symbol-circle symbol-25px overflow-hidden me-3">
                                          <a href="/keen/demo1/apps/ecommerce/customers/details.html">
                                             <div class="symbol-label">
                                                <img src="/keen/demo1/assets/media/avatars/300-23.jpg" alt="Dan Wilson" class="w-100">
                                             </div>
                                          </a>
                                       </div>
                                       <!--end::Avatar-->
                                       <!--begin::Name-->
                                       <a href="/keen/demo1/apps/ecommerce/customers/details.html" class="text-gray-600 text-hover-primary">
                                       Dan Wilson                                </a>
                                       <!--end::Name-->
                                    </div>
                                 </td>
                              ...
                              <tr>
                                 ...
                                 <td class="fw-bold text-end">
                                    <a href="/keen/demo1/apps/user-management/users/view.html" class="text-gray-600 text-hover-primary">
                        ...
                        <table class="table align-middle table-row-dashed mb-0 fs-6 gy-5 min-w-300px">
                           <tbody class="fw-semibold text-gray-600 border-top">
                              <tr>
                                 ...
                                 <td class="fw-bold text-end"><a href="/keen/demo1/apps/invoices/view/invoice-3.html" class="text-gray-600 text-hover-primary">#INV-000414</a></td>
                              </tr>
                              <tr>
                                 <td class="text-muted">
                                    <div class="d-flex align-items-center">
            ...
            <div class="tab-content">
               <!--begin::Tab pane-->
               <div class="tab-pane fade" id="kt_ecommerce_sales_order_summary" role="tab-panel">
                  <!--begin::Orders-->
                  <div class="d-flex flex-column gap-7 gap-lg-10">
                     <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             ...
                                             <!--begin::Title-->
                                             <div class="ms-5">
                                                <a href="/keen/demo1/apps/ecommerce/catalog/edit-product.html" class="fw-bold text-gray-600 text-hover-primary">Product 1</a>
                                                <div class="fs-7 text-muted">Delivery Date: 13/11/2024</div>
                                             </div>
                                             <!--end::Title-->
                                          </div>
                                       </td>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <!--begin::Thumbnail-->
                                             <a href="/keen/demo1/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                             <span class="symbol-label" style="background-image:url(/keen/demo1/assets/media//stock/ecommerce/100.png);"></span>
                                             </a>
                                             <!--end::Thumbnail-->
                                             <!--begin::Title-->
                                             <div class="ms-5">
                                                <a href="/keen/demo1/apps/ecommerce/catalog/edit-product.html" class="fw-bold text-gray-600 text-hover-primary">Footwear</a>
                                                <div class="fs-7 text-muted">Delivery Date: 13/11/2024</div>
                                             </div>
                                             <!--end::Title-->
                                          </div>
                  ...
                  <div class="d-flex flex-column gap-7 gap-lg-10">
                     ...
                     <div class="card card-flush py-4 flex-row-fluid">
                        ...
                        <div class="card-body pt-0">
                           <div class="table-responsive">
                              <!--begin::Table-->
                              <table class="table align-middle table-row-dashed mb-0 fs-6 gy-5">
                                 <tbody class="fw-semibold text-gray-600 border-top">
                                    <tr>
