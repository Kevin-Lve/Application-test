...
<html lang="fr" >
    ...
    <head>
        ...
        <meta charset="utf-8"/>
        <link rel="canonical" href="https://preview.keenthemes.com/keen/demo1/apps/ecommerce/catalog/add-product.html"/>
...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <!--begin::Form-->
<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="/keen/demo1/apps/ecommerce/catalog/products.html">
    <!--begin::Aside column-->
...
<div class="card card-flush py-4">
    ...
    <div class="card-body text-center pt-0">
        ...
        <!--begin::Description-->
        <div class="text-muted fs-7">Définir l'image de la vignette du produit. Seuls les fichiers *.png, *.jpg et *.jpeg sont acceptés.</div>
        <!--end::Description-->
    </div>
    <!--end::Card body-->
</div>
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_product_status_select">
            <option></option>
            <option value="published" selected>Disponible</option>
            <option value="draft">Préparation</option>
            <option value="scheduled">Réparation</option>
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <select class="form-select mb-2" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple">
            <option></option>
                            <option value="Computers">Ordinateur Fixe</option>
                            <option value="Watches">Ordinateur Portable</option>
                            <option value="Headphones">Clavier</option>
                            <option value="Footwear">Souris</option>
                            <option value="Cameras">Ecran</option>
                            <option value="Shirts">Télèphone</option>
                            <option value="Household">Câble</option>
                            <option value="Handbags">Accéssoire</option>
                            <option value="Wines">Back-Office</option>
                            <option value="Sandals">Chargeur</option>
                    </select>
        <!--end::Select2-->

        <!--begin::Description-->
        <div class="text-muted fs-7 mb-7">Ajouter un produit à une catégorie.</div>
        <!--end::Description-->
        <!--end::Input group-->

        <!--begin::Button-->
        <a href="/keen/demo1/apps/ecommerce/catalog/add-category.html" class="btn btn-light-primary btn-sm mb-10">
            <i class="ki-duotone ki-plus fs-2"></i>            Ajouter catégorie
        </a>
        <!--end::Button-->
...
<div class="card card-flush py-4">
    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            <!--begin::Label-->
            <label class="required form-label">Nom Equipement</label>
            <!--end::Label-->
        ...
        <script>
            var hostUrl = "/keen/demo1/assets/";        </script>
                    ...
                    <!--begin::Custom Javascript(used for this page only)-->
                            <script src="/keen/demo1/assets/js/custom/apps/ecommerce/catalog/save-product.js"></script>
