@extends('layouts.app') @section('title') Liste des Emplacements @stop @section('content')
            ...
            <div class="card card-flush">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('emplacement.create.show') }}">
                ...
                <div class="card-body pt-0">
                    ...
                    <div id="kt_permissions_table_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            ...
                            <table class="table align-middle table-row-bordered fs-6 gy-5 mb-0 dataTable" id="kt_permissions_table" style="width: 100%;">
                                ...
                                <tbody class="fw-semibold text-gray-600 border-top">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($emplacement->created_at) {{ $emplacement->created_at }} @else - @endif
                                        </td>
                                        <td class="text-end">
                                        <a href="{{ route('it.emplacement.show', ['id' => $emplacement->id]) }}">
                                                <button class="btn btn-icon btn-light-primary w-30px h-30px" data-kt-permissions-table-filter="delete_row">
                                                    <i class="fa-solid fa-eye"></i>
                                                </button>
                                            </a>
                                            <a href="{{ route('emplacement.supprimer', ['id' => $emplacement->id]) }}" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet emplacement ?')">
                        ...
                        <div id="" class="row">
                            {!! $emplacements->links('vendor.pagination.kevinPagination') !!}
                        </div>
                    </div>
                    <!--end::Table-->
                </div>
