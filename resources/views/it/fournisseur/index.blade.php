@extends('layouts.app') @section('title') Liste des Fournisseurs @stop @section('content')
            ...
            <div class="card card-flush">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('fournisseur.create.show') }}">
                ...
                <div class="card-body pt-0">
                    ...
                    <div id="kt_permissions_table_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                            ...
                            <<table class="table align-middle table-row-bordered fs-6 gy-5 mb-0 dataTable" id="kt_permissions_table" style="width: 100%;">
                                ...
                                <tbody class="fw-semibold text-gray-600 border-top">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($fournisseur->created_at) {{ $fournisseur->created_at }} @else - @endif
                                        </td>
                                        <td class="text-end">
                                        <a href="{{ route('it.fournisseur.show', ['id' => $fournisseur->id]) }}">
                                                <button class="btn btn-icon btn-light-primary w-30px h-30px" data-kt-permissions-table-filter="delete_row">
                                                    <i class="fa-solid fa-eye"></i>
                                                </button>
                                            </a>
                                            <a href="{{ route('fournisseur.supprimer', ['id' => $fournisseur->id]) }}" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce Fournisseur ?')">
                        ...
                        <div id="" class="row">
                            {!! $fournisseurs->links('vendor.pagination.kevinPagination') !!}
                        </div>
                    </div>
                    <!--end::Table-->
                </div>
